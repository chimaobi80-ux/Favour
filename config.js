...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~DtozGKBZ#c3lMBx7cb7y2xAMut3IZBPynR6yR4_FVZqUQv8QIrxk",  // Your bot's session ID (keep it secure)
    PREFIX: getConfig("PREFIX") || ".",  // Command prefix (e.g., "., / ! * - +")
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "𝐃𝐈𝐕𝐈𝐍𝐄-𝐌𝐃",  // Bot's display name
    ...
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "𝐃𝐈𝐕𝐈𝐍𝐄",           // Owner's name
    ...
    STICKER_NAME: process.env.STICKER_NAME || "𝐃𝐈𝐕𝐈𝐍𝐄-𝐌𝐃",     // Sticker pack name

    
    // ===== MEDIA & AUTOMATION =====
    AUTO_RECORDING: process.env.AUTO_RECORDING || "false",      // Auto-record voice notes?
    AUTO_TYPING: process.env.AUTO_TYPING || "false",   // Show typing indicator?
    MENU_IMAGE_URL: getConfig("MENU_IMAGE_URL") || "https://files.catbox.moe/m96ecn.jpg",  // Bot's "alive" image
